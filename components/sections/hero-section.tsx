...
export default function HeroSection() {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-professional">
      ...
      {/* Main content */}
      <div className="relative z-10 mobile-container pt-20 pb-8">
        {/* Mobile-first layout */}
        <div className="flex flex-col space-y-8 lg:grid lg:grid-cols-2 lg:gap-12 lg:space-y-0 items-center">
          ...
          <div className="text-center lg:text-left order-1">
            ...
            <h1 ref={titleRef} className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-6 leading-tight">
              Transform Your
            ...
            <p ref={subtitleRef} className="text-base sm:text-lg text-slate-300 mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed">
            ...
            <div ref={ctaRef} className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-navy-600 to-emerald-600 hover:from-navy-700 hover:to-emerald-700 text-white px-8 py-4 text-base group transition-all duration-300 shadow-xl btn-glow w-full sm:w-auto h-14 touch-target"
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-slate-600 text-slate-300 hover:bg-slate-800/50 hover:border-navy-400 hover:text-white px-8 py-4 text-base group transition-all duration-300 backdrop-blur-sm w-full sm:w-auto h-14 touch-target"
            ...
            <motion.div
              className="flex items-center justify-center lg:justify-start space-x-8 text-slate-400 mb-8"
          ...
          <div className="relative order-2 w-full max-w-sm sm:max-w-md lg:max-w-none">
